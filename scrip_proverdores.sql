-- PROVEEDORES
 ...
 DELIMITER //
CREATE PROCEDURE procInsertProveedor (IN v_nit VARCHAR(45), IN v_nombre VARCHAR(45), IN v_contacto VARCHAR(20))
BEGIN
...
DELIMITER //
CREATE PROCEDURE procUpdateProveedor (IN v_id INT, IN v_nit VARCHAR(45), IN v_nombre VARCHAR(45), IN v_contacto VARCHAR(20))
BEGIN
